export default {
  ...
  "home.bullet.a.description": "Хостујте PrivCloud_Sharing на својој машини.",
  ...
  "admin.config.general.app-url.description": "На којој URL адреси је доступан PrivCloud_Sharing",
