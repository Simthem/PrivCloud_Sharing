export default {
  ...
  "home.bullet.a.description": "Φιλοξενήστε το PrivCloud_Sharing στο δικό σας μηχάνημα.",
  ...
  "admin.config.general.app-url.description": "Η διεύθυνση URL όπου το PrivCloud_Sharing είναι διαθέσιμο",
