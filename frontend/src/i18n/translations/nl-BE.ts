export default {
  ...
  "home.bullet.a.description": "Host PrivCloud_Sharing op uw eigen machine.",
  ...
  "admin.config.general.app-url.description": "De URL waar PrivCloud_Sharing bereikbaar is",
  ...
  "admin.config.share.allow-admin-access-all-shares":
    "Sta beheerders toe om toegang te krijgen tot alle shares",
  "admin.config.share.allow-admin-access-all-shares.description":
    "Wanneer ingeschakeld, kunnen beheerders toegang krijgen tot alle shares zonder share tokens of wachtwoorden nodig te hebben. Dit stelt beheerders in staat om bestanden van elke share te bekijken en te downloaden voor beheerdoeleinden.",
