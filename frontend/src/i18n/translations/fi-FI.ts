export default {
  ...
  "home.bullet.a.description": "Isännöi \"PrivCloud_Sharing\" omalla palvelimellasi.",
  ...
  "admin.config.general.app-url.description": "Millä URL-osoitteella PrivCloud_Sharing on saatavilla",
