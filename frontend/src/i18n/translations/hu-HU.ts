export default {
  ...
  "home.bullet.a.description": "A PrivCloud_Sharing megosztót saját gépéről futtathatja.",
  ...
  "admin.config.general.app-url.description": "A PrivCloud_Sharing megosztáskezelőre mutató hivatkozás",
