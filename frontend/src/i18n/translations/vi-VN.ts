export default {
  ...
  "home.bullet.a.description": "Host PrivCloud_Sharing on your own machine.",
  ...
  "admin.config.general.app-url.description": "On which URL PrivCloud_Sharing is available",
