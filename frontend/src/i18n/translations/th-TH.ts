export default {
  ...
  // END navbar
  // /
  "home.title": "แชร์ไฟล์อย่างมั่นใจด้วย <h>การเข้ารหัสจากต้นทางถึงปลายทาง</h>",
  "home.description": "คุณอยากให้บริษัทภายนอกเช่น WeTransfer เข้าถึงไฟล์ส่วนตัวของคุณหรือเปล่า?",
  "home.bullet.a.name": "Self-Hosted",
  "home.bullet.a.description": "โฮสต์ PrivCloud_Sharing บนเครื่องของคุณเอง.",
  ...
  "account.reverseShares.table.remaining": "จำนวนครั้งที่เหลือ",
  ...
  "admin.config.general.app-url.description": "URL ที่สามารถเข้าถึงแอพพลิเคชัน PrivCloud_Sharing ได้",
