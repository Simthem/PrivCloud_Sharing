export default {
  ...
  "home.bullet.a.description": "Gostuj PrivCloud_Sharing na svoji lastni napravi.",
  ...
  "admin.config.general.app-url.description": "Na katerem URL-ju je dostopen PrivCloud_Sharing",
