export default {
  ...
  "home.bullet.a.description": "PrivCloud_Sharing работает на вашей машине.",
  ...
  "admin.config.general.app-url.description": "Адрес на котором доступен PrivCloud_Sharing",
