export default {
  ...
  "home.bullet.a.description": "Utrzymuj PrivCloud_Sharing na własnym serwerze.",
  ...
  "admin.config.general.app-url.description": "Pod którym adresem URL PrivCloud_Sharing jest dostępny",
